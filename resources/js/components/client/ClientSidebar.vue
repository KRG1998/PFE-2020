        ...
        <div class="sb-sidenav-menu">
          <div class="nav">
            ...
            <router-link to="/client/profile" class="nav-link text-secondary">
              <img
                style="height: 120px;width:120px;display:block;margin-left: auto;margin-right:auto"
                class="rounded-circle border-info img-thumbnail"  :src="'../storage/clients_photos/'+client.photo"
                v-if="exist==1"
                alt="profile photo"
              />
              <img
            ...
            <div class="row w-100">
             <div class="col">
                <span class="text-center" style="display:block;margin-left: auto;margin-right: auto">
              <router-link to="/client/profile" class="" style="text-decoration:none;"><h4 class="text-capitalize">{{user.first_name}} {{user.last_name}}</h4></router-link>
            </span>
             </div>
            </div>
